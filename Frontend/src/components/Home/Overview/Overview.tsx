...
function Overview() {
    ...
    return (
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
                    <Link to="/home/createtemplate" className="border border-black pb-[100%] relative rounded-lg">
                    ...
                    {data && data.map((template, index) =>
                        ...
                        <Link to={`/home/template/${template.id}`} key={template.name + index} className="border border-black pb-[100%] relative rounded-lg">
                            <div className="absolute inset-0 flex items-center justify-center flex-col gap-4">
